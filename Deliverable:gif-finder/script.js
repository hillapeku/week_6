...
function sendApiRequest(searchInput) {
  
    fetch("https://api.giphy.com/v1/gifs/search?api_key=Yn5AxK73zuAUn7IkEtD0QCjes3o1rqAj&q="+searchInput+"&limit=25&offset=0&rating=G&lang=en")
    .then(function(data) {
      return data.json(); 
    })
    .then(function(json) {
